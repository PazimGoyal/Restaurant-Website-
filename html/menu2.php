...
<nav class="navbar   navigation">
  ...
  <table class="menus table">
    ...
    <td style="border-top:none;"><a href="menu.php">ENTREE</a></td>
      <td style="border-top:none;"><a class="active" href="menu2.php">MAIN COURSES</a></td>
...
<center>
<h3 class="white">Lunch Special<br>Half Curry / Half Rice + Can Soft Drink Only <br>Take Away $11.90  Dine-in $13.90
</h3>
<br></center>
</div>
...
<h3 style="padding-left:50px;"> <img src="../img/nveg.png" width="35px"> Chicken/beef/Lamb</h3>
  </div>    <?php
...
echo "<tr><td>$i</td><td style='text-align:left'>". $row["Product"]."</td><td>$ ".$row["Full_price"]."</td></tr>";
$i=$i+1;	
}
echo "</table></center>";
...
<h2 style="padding-left:50px;"> <img src="../img/nveg.png" width="35px">
 Tandoori</h2>
  </div>          <?php
$sql = "SELECT Product,Full_price
...
<h3 style="padding-left:50px;">
 <img src="../img/nveg.png" width="35px"> <img src="../img/veg.png" width="35px"> Moonlight Special</h3>
  </div>          <?php
$sql = "SELECT Product,Full_price
...
<h2 style="padding-left:50px;"> <img src="../img/veg.png" width="35px">
 Rice</h2>
  </div>          <?php
$sql = "SELECT Product,Full_price
...
?>
  ...
  <div class="row row1">
    <div class="col-lg-6 c1">
<div class="head_2" style="background:url(../img/menu/accompaniments.jpg) no-repeat center;	border: 2px ridge #fff; background-size:cover; height:80px; margin:0px; padding-top:10px; width:100%;">
<h3 style="padding-left:50px;"> <img src="../img/veg.png" width="35px">Accompaniments</h3>
  </div>          <?php
$sql = "SELECT Product,Full_price
